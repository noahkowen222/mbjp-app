...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-L-dMCPMS.mjs");
...
var manifest = {
	"5bdb4a4076f0defed2a1e88344e55207d7bdcac9475a1858defb13d52d58d14c": {
		functionName: "verifyMemberAction_createServerFn_handler",
		importer: () => import("./actions-D0t90bad.mjs")
	},
	"73c760414c7686e70393c1092eaef38e2a1b78b359d5e498e947b787e69554e9": {
		functionName: "rejectMemberAction_createServerFn_handler",
		importer: () => import("./actions-Bl9e9979.mjs")
	},
	"8d72772939d2efcea0f543551b5454ed6075fec6aa84dd749340cafe6bae0527": {
		functionName: "approveMemberAction_createServerFn_handler",
		importer: () => import("./actions-Bl9e9979.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		...
		Promise.resolve().then(() => start_exports),
...
//#endregion
export { createServerEntry, server_default as default, createServerRpc as n, createServerFn as r, createSsrRpc as t };
