...
const cmsFallbacks: Record<AppLanguage, Record<CmsPageSlug, CmsFallbackCopy>> = {
  en: {
    about: {
      eyebrow: 'About MBJP',
      title: 'About Marwardi Bhatti Jamaat Pakistan',
      subtitle:
    ...
    constitution: {
      ...
      title: 'MBJP Constitution',
      subtitle:
        'The constitutional structure, roles, responsibilities and organizational rules of MBJP.',
      content:
        'The constitution defines MBJP membership, organizational structure, Central Executive Committee, Central Advisory Committee, provincial, divisional, district and taluka units, duties of office bearers, program management, finance rules, discipline, records and reporting.\n\nCurrent hierarchy:\nCEC → Advisory → Provincial → Divisional → District → Taluka\n\nThis page can be updated from the Admin CMS panel.',
    },
    cwc: {
    ...
    contact: {
      eyebrow: 'Contact',
      title: 'Contact Marwardi Bhatti Jamaat Pakistan',
      subtitle:
  ...
  ur: {
    about: {
      ...
      title: 'مارواڑی بھٹی جماعت پاکستان کا تعارف',
      subtitle:
        'سندھ بھر کے مارواڑی بھٹی خاندانوں کے لیے غیر سیاسی، فلاحی اور ممبرشپ سے تصدیق شدہ کمیونٹی پلیٹ فارم۔',
      content:
        'مارواڑی بھٹی جماعت پاکستان (MBJP) ایک کمیونٹی فلاحی پلیٹ فارم ہے جو ممبرشپ، تعلیم، صحت، ویلفیئر کیسز، روزگار، عطیات اور تصدیق شدہ عوامی ریکارڈ کو منظم کرنے کے لیے بنایا گیا ہے۔\n\nتنظیم شفاف ممبرشپ تصدیق، ذمہ دار ایڈمن جائزہ، ڈویژن، ضلع اور تعلقہ سطح کی کوآرڈینیشن اور ڈیجیٹل ریکارڈ کے ذریعے کام کرے گی۔\n\nیہ صفحہ Admin CMS Panel سے اپڈیٹ کیا جا سکتا ہے۔',
    },
    'vision-mission': {
      eyebrow: 'وژن اور مشن',
      title: 'وژن اور مشن',
      subtitle:
        'سندھ بھر کی مارواڑی بھٹی برادری کو منظم، تعلیم یافتہ، خود کفیل اور خدمت گزار بنانا۔',
      content:
        'وژن:\nسندھ میں آباد مارواڑی بھٹی برادری کو تعلیمی، معاشی، سماجی، اخلاقی اور تنظیمی طور پر مضبوط، باوقار، خود کفیل اور متحد بنانا۔\n\nمشن:\nمستحق اور باصلاحیت ممبران کے لیے ممبرشپ، تعلیم، صحت، روزگار، ویلفیئر، عطیات اور باہمی تعاون کا منظم نظام قائم کرنا۔\n\nیہ صفحہ Admin CMS Panel سے اپڈیٹ کیا جا سکتا ہے۔',
    },
    manifesto: {
      eyebrow: 'منشور',
      title: 'منشور / Manshoor',
      subtitle:
        'مارواڑی بھٹی جماعت پاکستان کے رہنما اصول اور عوامی عہد۔',
      content:
        'مارواڑی بھٹی جماعت پاکستان تعلیم، صحت، روزگار، ویلفیئر، سماجی مدد، نمائندگی، اتحاد، وقار اور خدمت کے لیے کام کرے گی۔\n\nمنشور کے اہم نکات:\n- تعلیم سپورٹ اور اسکالرشپس\n- صحت مدد اور ایمرجنسی سپورٹ\n- روزگار اور اسکلز سپورٹ\n- مستحق خاندانوں کے لیے ویلفیئر کیسز\n- شفاف عطیات اور مالی ریکارڈ\n- کمیونٹی اتحاد اور تصدیق شدہ ممبرشپ\n\nیہ صفحہ Admin CMS Panel سے اپڈیٹ کیا جا سکتا ہے۔',
    },
    constitution: {
      eyebrow: 'آئین',
    ...
    cwc: {
      ...
      content:
        'مرکزی ورکنگ کمیٹی (CWC) مارواڑی بھٹی جماعت پاکستان کی اعلیٰ سطحی گورننگ اور ایگزیکٹو باڈی ہے۔\n\nمرکزی کابینہ کے عہدے:\n- چیئرمین\n- سینئر وائس چیئرمین\n- وائس چیئرمین\n- جنرل سیکریٹری\n- انفارمیشن سیکریٹری\n\nضرورت کے مطابق اضافی کمیٹیاں، ونگز اور ایڈوائزری بورڈز بنائے جا سکتے ہیں۔\n\nیہ صفحہ Admin CMS Panel سے اپڈیٹ کیا جا سکتا ہے۔',
    },
    contact: {
      eyebrow: 'رابطہ',
      title: 'مارواڑی بھٹی جماعت پاکستان سے رابطہ',
      subtitle:
  ...
  sd: {
    about: {
      eyebrow: 'MBJP بابت',
      title: 'مارواڙي ڀٽي جماعت پاڪستان جو تعارف',
      subtitle:
        'سنڌ جي مارواڙي ڀٽي خاندانن لاءِ غير سياسي، فلاحي ۽ ميمبرشپ تصديق ٿيل ڪميونٽي پليٽ فارم.',
      content:
        'مارواڙي ڀٽي جماعت پاڪستان (MBJP) هڪ ڪميونٽي فلاحي پليٽ فارم آهي، جيڪو ميمبرشپ، تعليم، صحت، ويلفيئر ڪيسز، روزگار، عطيا ۽ تصديق ٿيل عوامي رڪارڊ کي منظم ڪرڻ لاءِ ٺاهيو ويو آهي۔\n\nتنظيم شفاف ميمبرشپ تصديق، ذميوار ايڊمن جائزي، ڊويزن، ضلع ۽ تعلقي سطح جي ڪوآرڊينيشن ۽ ڊجيٽل رڪارڊ ذريعي ڪم ڪندي۔\n\nهي صفحو Admin CMS Panel مان اپڊيٽ ڪري سگهجي ٿو.',
    },
    'vision-mission': {
      eyebrow: 'وژن ۽ مشن',
      title: 'وژن ۽ مشن',
      subtitle:
        'سنڌ جي مارواڙي ڀٽي برادري کي منظم، تعليم يافته، خود ڪفيل ۽ خدمتگار بنائڻ.',
      content:
        'وژن:\nسنڌ ۾ رهندڙ مارواڙي ڀٽي برادري کي تعليمي، معاشي، سماجي، اخلاقي ۽ تنظيمي طور مضبوط، باوقار، خود ڪفيل ۽ متحد بنائڻ۔\n\nمشن:\nمستحق ۽ باصلاحيت ميمبرن لاءِ ميمبرشپ، تعليم، صحت، روزگار، ويلفيئر، عطيا ۽ باهمي تعاون جو منظم نظام قائم ڪرڻ۔\n\nهي صفحو Admin CMS Panel مان اپڊيٽ ڪري سگهجي ٿو.',
    },
    manifesto: {
      eyebrow: 'منشور',
      title: 'منشور / Manshoor',
      subtitle:
        'مارواڙي ڀٽي جماعت پاڪستان جا رهنما اصول ۽ عوامي عزم.',
      content:
        'مارواڙي ڀٽي جماعت پاڪستان تعليم، صحت، روزگار، ويلفيئر، سماجي مدد، نمائندگي، اتحاد، وقار ۽ خدمت لاءِ ڪم ڪندي۔\n\nمنشور جا اهم نڪتا:\n- تعليم سپورٽ ۽ اسڪالرشپس\n- صحت مدد ۽ ايمرجنسي سپورٽ\n- روزگار ۽ مهارتن جي سپورٽ\n- مستحق خاندانن لاءِ ويلفيئر ڪيسز\n- شفاف عطيا ۽ مالي رڪارڊ\n- ڪميونٽي اتحاد ۽ تصديق ٿيل ميمبرشپ\n\nهي صفحو Admin CMS Panel مان اپڊيٽ ڪري سگهجي ٿو.',
    },
    constitution: {
      eyebrow: 'آئين',
      title: 'MBJP آئين',
      subtitle:
        'MBJP جو آئيني ڍانچو، عهدا، ذميواريون ۽ تنظيمي قاعدا.',
      content:
        'آئين ۾ MBJP ميمبرشپ، تنظيمي ڍانچو، مرڪزي ورڪنگ ڪميٽي، ڊويزن، ضلع ۽ تعلقه يونٽس، عهديدارن جون ذميواريون، پروگرام مينيجمينٽ، مالي قاعدا، نظم و ضبط، رڪارڊ ۽ رپورٽنگ شامل آهن۔\n\nموجوده درجا بندي:\nمرڪز / Markaz → ڊويزن → ضلعو → تعلقو\n\nهي صفحو Admin CMS Panel مان اپڊيٽ ڪري سگهجي ٿو.',
    },
    cwc: {
      ...
      content:
        'مرڪزي ورڪنگ ڪميٽي (CWC) مارواڙي ڀٽي جماعت پاڪستان جي اعليٰ سطح جي گورننگ ۽ ايگزيڪيوٽو باڊي آهي۔\n\nمرڪزي ڪابينا جا عهدا:\n- چيئرمين\n- سينئر وائس چيئرمين\n- وائس چيئرمين\n- جنرل سيڪريٽري\n- انفارميشن سيڪريٽري\n\nضرورت مطابق اضافي ڪميٽيون، ونگز ۽ ايڊوائزري بورڊز ٺاهي سگهجن ٿا۔\n\nهي صفحو Admin CMS Panel مان اپڊيٽ ڪري سگهجي ٿو.',
    },
    contact: {
      eyebrow: 'رابطو',
      title: 'مارواڙي ڀٽي جماعت پاڪستان سان رابطو',
      subtitle:
...
const sharedCopy = {
  en: {
    ...
    donate: 'Donate',
    contact: 'Contact',
    officialContent: 'Official MBJP Content',
    cmsManaged:
    ...
    membershipText: 'Join MBJP as a verified member.',
    programs: 'Programs',
  ...
  ur: {
    ...
    donate: 'عطیہ دیں',
    contact: 'رابطہ',
    officialContent: 'سرکاری MBJP مواد',
    cmsManaged:
    ...
    membership: 'ممبرشپ',
    membershipText: 'تصدیق شدہ ممبر کے طور پر MBJP میں شامل ہوں۔',
    programs: 'پروگرامز',
  ...
  sd: {
    ...
    donate: 'عطيو ڏيو',
    contact: 'رابطو',
    officialContent: 'سرڪاري MBJP مواد',
    cmsManaged:
    ...
    membership: 'ميمبرشپ',
    membershipText: 'تصديق ٿيل ميمبر طور MBJP ۾ شامل ٿيو۔',
    programs: 'پروگرام',
...
const committeesCopy = {
  en: {
    ...
    description:
      'Publicly displayed Central Executive, Central Advisory, Provincial, Divisional, District and Taluka committees of Marwardi Bhatti Jamaat Pakistan with official office bearers and tenure details.',
    ...
    officialRecord:
      'Official public record of Marwardi Bhatti Jamaat Pakistan office bearers for this committee.',
  ...
  ur: {
    ...
    title: 'عوامی کمیٹیاں',
    description:
      'مارواڑی بھٹی جماعت پاکستان کی مرکزی ایگزیکٹو، مرکزی مشاورتی، صوبائی، ڈویژنل، ضلعی اور تعلقہ کمیٹیاں، سرکاری عہدیداران اور مدت کی تفصیل کے ساتھ۔',
    ...
    officialRecord:
      'اس کمیٹی کے لیے مارواڑی بھٹی جماعت پاکستان کے عہدیداران کا سرکاری عوامی ریکارڈ۔',
  ...
  sd: {
    ...
    title: 'عوامي ڪميٽيون',
    description:
      'مارواڙي ڀٽي جماعت پاڪستان جون مرڪزي ايگزيڪيوٽو، مرڪزي مشاورتي، صوبائي، ڊويزنل، ضلعي ۽ تعلقي ڪميٽيون، سرڪاري عهديدارن ۽ مدت جي تفصيل سان۔',
    ...
    officialRecord:
      'هن ڪميٽي لاءِ مارواڙي ڀٽي جماعت پاڪستان جي عهديدارن جو سرڪاري عوامي رڪارڊ.',
...
const mediaCopy = {
  en: {
    ...
    newsDescription:
      'Published updates from Marwardi Bhatti Jamaat Pakistan, including general announcements, program news, events and community activity.',
    ...
    eventsTitle: 'Upcoming and published MBJP events',
    eventsDescription:
    ...
    galleryTitle: 'MBJP events and community activity gallery',
    galleryDescription:
      'Published photos from MBJP meetings, programs, welfare activities, education support, health assistance and community events.',
  ...
  ur: {
    ...
    newsDescription:
      'مارواڑی بھٹی جماعت پاکستان کی شائع شدہ اپڈیٹس، جن میں عام اعلانات، پروگرام نیوز، ایونٹس اور کمیونٹی سرگرمیاں شامل ہیں۔',
    ...
    eventsTitle: 'آنے والے اور شائع شدہ MBJP ایونٹس',
    eventsDescription:
    ...
    galleryTitle: 'MBJP ایونٹس اور کمیونٹی سرگرمیوں کی گیلری',
    galleryDescription:
      'MBJP میٹنگز، پروگرامز، ویلفیئر سرگرمیوں، تعلیمی سپورٹ، صحت مدد اور کمیونٹی ایونٹس کی شائع شدہ تصاویر۔',
  ...
  sd: {
    ...
    newsDescription:
      'مارواڙي ڀٽي جماعت پاڪستان جون شايع ٿيل اپڊيٽس، جن ۾ عام اعلان، پروگرام خبرون، ايونٽس ۽ ڪميونٽي سرگرميون شامل آهن۔',
    ...
    eventsTitle: 'ايندڙ ۽ شايع ٿيل MBJP ايونٽس',
    eventsDescription:
    ...
    galleryTitle: 'MBJP ايونٽس ۽ ڪميونٽي سرگرمين جي گيلري',
    galleryDescription:
      'MBJP ميٽنگن، پروگرامن، ويلفيئر سرگرمين، تعليمي سپورٽ، صحت مدد ۽ ڪميونٽي ايونٽس جون شايع ٿيل تصويرون۔',
